...
def geometry():
    ...
    c_ref = 0.55  # [m] 
    ar = b_ref/c_ref
    j_ref = np.array([[25., 0.0, 0.47], [0.0, 32., 0.0], [0.47, 0.0, 56.]])

    # New wingspan and AR
    b_new = 51.6139516022557
    AR = 12.0
    ...
    # Scaled values
    m_new = m_ref*(b_new/b_ref)**kappa
    s_new = b_new**2.0/AR
    c_new = b_new/AR
    j_new = j_ref*(b_new/b_ref)**(kappa + 2.0)

    # Assign to geometry
    geometry['m_k'] = m_new  # [kg]
    geometry['s_ref'] = s_new  # [m^2]
    geometry['b_ref'] = b_new  # [m]
    geometry['c_ref'] = c_new  # [m]
