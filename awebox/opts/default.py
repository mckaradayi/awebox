...
def set_default_options(default_user_options, help_options):
    ...
    default_options_tree = [
        ...
        ('solver',  'homotopy_method',None,  'iota',       'penalty',  ('homotopy method used', ['penalty', 'classic']), 's'),
        ...
        ('solver',  'homotopy_step',  None, 'iota',         1.0,        ('classical continuation homotopy parameter step',None), 's'),
