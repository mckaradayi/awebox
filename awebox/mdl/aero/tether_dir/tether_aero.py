...
def get_force_outputs(model_options, variables, parameters, atmos, wind, upper_node, tether_cd_fun, outputs, architecture):
    ...
    [integral_lower, integral_upper] = get_integral_forces(model_options, variables, atmos, wind, upper_node, parameters,architecture)
    ...
    outputs['tether_aero']['integral_upper' + str(upper_node)] = integral_upper
    outputs['tether_aero']['integral_lower' + str(upper_node)] = integral_lower
...
def get_integral_forces(model_options, variables, atmos, wind, n, parameters, architecture):
    ...
    q_upper, q_lower, dq_upper, dq_lower = element.get_upper_and_lower_pos_and_vel(variables, n, architecture)
    diam = element.get_element_diameter(variables, n, architecture)
